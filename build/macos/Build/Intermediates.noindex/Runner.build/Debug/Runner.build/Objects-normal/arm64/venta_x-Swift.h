...
#ifndef VENTA_X_SWIFT_H
#define VENTA_X_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="venta_x",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7venta_x11AppDelegate")
...
SWIFT_CLASS("_TtC7venta_x17MainFlutterWindow")
